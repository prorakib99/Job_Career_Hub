        ...
        <>
            <div className="rounded-lg border border-gray-200 p-10">
                ...
                <div className="mt-4 flex gap-4">
                    <button className="text-indigo-400 text-base font-extrabold rounded border border-indigo-400 py-2 px-4 cursor-pointer focus:outline-0 focus:bg-indigo-400 focus:text-white">{remote_or_onsite}</button>
                </div>
